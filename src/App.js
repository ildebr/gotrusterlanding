      ...
      <Router>
        ...
        <Switch>
          ...
          <Route
            ...
            component={EmailVerificationActivate}
          />
          ...
          <GuardedRoute
            path="/publicbusiness"
            exact
            component={PublicBusiness}
            auth={auth.loggedIn()}
          />
          <GuardedRoute
            path="/editmybusiness"
            component={EditMyBusiness}
            auth={auth.loggedIn()}
          />
          <GuardedRoute
            path="/slantedPublic"
            component={SlantedPublicBusiness}
            auth={auth.loggedIn()}
          />
          ...
          {/* Phone */}
          <GuardedRoute
            path="/automaticValidationphone"
            component={AutomaticValidationPhone}
            auth={auth.loggedIn()}
          />
          <GuardedRoute
            path="/welcomeAgainAutomaticvalidationphone"
            component={WelcomeAgainAutomaticValidationPhone}
            auth={auth.loggedIn()}
          />
          <GuardedRoute
            path="/completedAutomaticvalidationphone"
            component={CompletedAutomaticValidationPhone}
            auth={auth.loggedIn()}
          />

          {/* MercadoLibre */}
          <GuardedRoute
            path="/automaticValidationmercadolibre"
            component={AutomaticValidationMercadoLibre}
            auth={auth.loggedIn()}
          />
          <GuardedRoute
            path="/failedAutomaticvalidationmercadolibre"
            component={FailedAutomaticValidationMercadoLibre}
            auth={auth.loggedIn()}
          />
          <GuardedRoute
            path="/readyAutomaticvalidationmercadolibre"
            component={ReadyAutomaticValidationMercadoLibre}
            auth={auth.loggedIn()}
          />
          <GuardedRoute
            path="/successAutomaticvalidationmercadolibre"
            component={SuccessAutomaticValidationMercadoLibre}
            auth={auth.loggedIn()}
          />

          {/* LinkedIn */}
          <GuardedRoute
            path="/automaticValidationlinkedin"
            component={AutomaticValidationLinkedIn}
            auth={auth.loggedIn()}
          />
          <GuardedRoute
            path="/failedAutomaticvalidationlinkedin"
            component={FailedAutomaticValidationLinkedIn}
            auth={auth.loggedIn()}
          />
          <GuardedRoute
            path="/readyAutomaticvalidationlinkedin"
            component={ReadyAutomaticValidationLinkedIn}
            auth={auth.loggedIn()}
          />
          <GuardedRoute
            path="/successAutomaticvalidationlinkedin"
            component={SuccessAutomaticValidationLinkedIn}
            auth={auth.loggedIn()}
          />

          {/* Facebook */}
          <GuardedRoute
            path="/automaticValidationFacebook"
            component={AutomaticValidationFacebook}
            auth={auth.loggedIn()}
          />
          <GuardedRoute
            path="/failedAutomaticValidationFacebook"
            component={FailedAutomaticValidationFacebook}
            auth={auth.loggedIn()}
          />
          <GuardedRoute
            path="/readyAutomaticValidationFacebook"
            component={ReadyAutomaticValidationFacebook}
            auth={auth.loggedIn()}
          />
          <GuardedRoute
            path="/successAutomaticValidationFacebook"
            component={SuccessAutomaticValidationFacebook}
            auth={auth.loggedIn()}
          />

          {/* Binance */}
          <GuardedRoute
            path="/automaticValidationBinance"
            component={AutomaticValidationBinance}
            auth={auth.loggedIn()}
          />
          <GuardedRoute
            path="/failedAutomaticValidationBinance"
            component={FailedAutomaticValidationBinance}
            auth={auth.loggedIn()}
          />
          <GuardedRoute
            path="/readyAutomaticValidationBinance"
            component={ReadyAutomaticValidationBinance}
            auth={auth.loggedIn()}
          />
          <GuardedRoute
            path="/successAutomaticValidationBinance"
            component={SuccessAutomaticValidationBinance}
            auth={auth.loggedIn()}
          />
          {/* Manual validations */}
          ...
          />
          <GuardedRoute
            path="/validation/dniSuccess"
            exact
            component={DniValidationSuccess}
            auth={auth.loggedIn()}
          />
          <GuardedRoute
            path="/validation/dniReady"
            exact
            component={DniValidationReady}
            auth={auth.loggedIn()}
          />
          <GuardedRoute
            path="/validation/dniError"
            exact
            component={DniValidationError}
            auth={auth.loggedIn()}
          />

          {/* Direccion */}
          <GuardedRoute
            path="/validation/direccion"
            exact
            component={DireccionValidation}
            auth={auth.loggedIn()}
          />
          <GuardedRoute
            path="/validation/direccionSuccess"
            exact
            component={DireccionValidationSuccess}
            auth={auth.loggedIn()}
          />
          <GuardedRoute
            path="/validation/direccionReady"
            exact
            component={DireccionValidationReady}
            auth={auth.loggedIn()}
          />
          <GuardedRoute
            path="/validation/direccionError"
            exact
            component={DireccionValidationError}
            auth={auth.loggedIn()}
          />

          {/* Afip */}
          <GuardedRoute
            path="/validation/afip"
            exact
            component={AfipValidation}
            auth={auth.loggedIn()}
          />
          <GuardedRoute
            path="/validation/afipSuccess"
            exact
            component={AfipValidationSuccess}
            auth={auth.loggedIn()}
          />
          <GuardedRoute
            path="/validation/afipError"
            exact
            component={afipValidationError}
            auth={auth.loggedIn()}
          />
          <GuardedRoute
            path="/validation/afipReady"
            exact
            component={AfipValidationReady}
            auth={auth.loggedIn()}
          />
          ...
          <GuardedRoute
            path="/validation/selfie"
            exact
            component={SelfieValidation}
            auth={auth.loggedIn()}
          />
          <GuardedRoute
            path="/validation/selfieSuccess"
            exact
            component={SelfieValidationSuccess}
            auth={auth.loggedIn()}
          />
          <GuardedRoute
            path="/validation/selfieReady"
            exact
            component={SelfieValidationReady}
            auth={auth.loggedIn()}
          />
          <GuardedRoute
            path="/validation/selfieError"
            exact
            component={SelfieValidationError}
            auth={auth.loggedIn()}
          />
        </Switch>
      </Router>
