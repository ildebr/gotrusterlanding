    ...
    >
      <Grid container style={{ padding: 30, marginTop: 15, paddingRight: 0 }}>
        ...
        >
          <Grid container xs={1} xl={1} sm={1}>
            <Link href={userActive ? '/reputation' : '/'}>
              <img src={MiReputacion} alt="reputacion" />
            </Link>
          </Grid>
        ...
        >
          ...
          <Grid container xs={11} xl={11} sm={11} justify="flex-start">
            ...
            >
              ...
              >
                Obtené 20 puntos truster para desbloquear
              </Typography>
            </Grid>
          </Grid>
        </Grid>
        ...
        >
          <Grid container xs={1} xl={1} sm={1}>
            <Link href="/security">
              <img src={MiPerfil} alt="seguridad" />
            </Link>
          </Grid>
          <Grid container xs={11} xl={11} sm={11} justify="flex-start">
            <Link href="/security">
        ...
        >
          ...
          <Grid container xs={11} xl={11} sm={11} justify="flex-start">
            ...
            >
              ...
              >
                Obtené 13 puntos truster para desbloquear
              </Typography>
            </Grid>
          </Grid>
        </Grid>
        ...
        >
          <Grid container xs={1} xl={1} sm={1}>
            <Link href="/">
              <img src={CerrarSesion} alt="cerrarsesion" />
            </Link>
          </Grid>
          <Grid container xs={11} xl={11} sm={11} justify="flex-start">
            <Link href="/">
