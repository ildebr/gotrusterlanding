    ...
    >
      ...
      >
        <Grid container xs={6} xl={6} sm={6} justify="flex-start">
          ...
          >
            Sumá <b style={{ color: 'white' }}>22 puntos</b> para compartir tu
            perfil
          </Typography>
        </Grid>
        <Grid container xs={2} xl={2} sm={2}></Grid>
      ...
      >
        <Grid container xs={6} xl={6} sm={6} justify="flex-start">
          ...
          >
            Sumá <b style={{ color: 'white' }}>22 puntos</b> para publicar tu
            negocio
          </Typography>
        </Grid>
        <Grid container xs={2} xl={2} sm={2}></Grid>
      ...
      >
        <Grid container xs={6} xl={6} sm={6} justify="flex-start">
          ...
          >
            Sumá <b style={{ color: 'white' }}>12 puntos</b> para desbloquear
            firma web
          </Typography>
        </Grid>
        <Grid container xs={2} xl={2} sm={2}></Grid>
