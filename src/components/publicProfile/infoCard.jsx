...
const CompanyDescription = 'International branding, architecture, software and brand positioning firm. Experts in brand development and commercial spaces'
...
const InfoCard = () => {
  ...
  return (
    <Grid position="static" color="transparent" style={{
      ...
      <div className={classes.backgroundCut} style={{ zIndex: 0, marginTop: 0 }} >
      ...
      <Grid container alignItems='center' justify="center" xs={12} xl={12} sm={12} style={{
        ...
        borderRadius: '10px', padding: '10px', maxHeight: '310px'
      }}>
        <Grid item container alignItems='center' justify="center" xs={12} xl={12} sm={12}>
          <Grid item container alignItems='center' justify="flex-start" xs={1} xl={1} sm={1}>
            <img src={negocioImagen} alt='elipseGris' />
          </Grid>
          <Grid item container alignItems='center' justify="flex-start" xs={11} xl={11} sm={11}>
            <Typography className={classes.title}>
              {CompanyTitle}
            </Typography>
          </Grid>
        </Grid>
        <Grid item container justify='flex-start' alignItems='center' style={{marginTop: '10px'}} xs={12} xl={12} sm={12}>
          <Typography className={classes.subtitle}>
            {CompanySubTitle}
          </Typography>
        </Grid>
        <Grid item container justify='flex-start' alignItems='center' style={{ marginTop: '10px' }} xs={12} xl={12} sm={12}>
          <Typography className={classes.truster}>
            {CompanyTruster}
          </Typography>
        </Grid>
        <Grid item container justify='flex-start' alignItems='center' style={{ marginTop: '10px' }} xs={12} xl={12} sm={12}>
