      ...
      >
        ...
        >
          <Grid
            ...
            sm={8}
          >
            <Typography className={classes.level}>Nivel</Typography>
            <Typography className={classes.prot}>Pro Truster</Typography>
          </Grid>
          <Grid
            container
            alignItems="center"
          ...
          >
            ...
            >
              ...
              <Grid
                ...
                sm={8}
              >
                <Typography className={classes.trustern}>{points}</Typography>
              </Grid>
            </Grid>
            <Grid
              container
