  ...
  return (
    <React.Fragment>
      ...
      >
        <img
          src={imagen}
          style={{ width: '150px', paddingRight: '47px', marginTop: '80px' }}
        />
        <Typography className={classes.titulo}>Compartí tu perfil</Typography>
        <Typography className={classes.subtitulo}>
          La información compartida no divulgará datos personales, sólo
