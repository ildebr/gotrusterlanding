  ...
  return (
    ...
    >
      ...
      <Grid item container spacing={1} direction="row" justify="flex-start">
        ...
        >
          <Grid item xs>
            <Typography className={classes.label}>Factura</Typography>
          </Grid>
          <Grid item xs>
            <img
              ref={invoiceImageRef}
              src={`${BaseURLImage() + IMAGE_INVOICE_PATH + data.email}.png`}
              onError={(e) => setDefaultImage(e, Factura)}
              className={classes.facturaImage}
              onClick={() => openModal(1)}
            />
            <Modal
              showModal={showModal1}
              setShowModal={setShowModal1}
              imageRef={invoiceImageRef}
            />
          </Grid>
          <Grid item xs>
            <Typography
        ...
        >
          ...
          >
            <Grid item xs>
              <Typography className={classes.label}>Dni</Typography>
            </Grid>
            <Grid item xs container spacing={1} direction="column">
              ...
              <Grid item>
                <img
                  ...
                  onError={(e) => setDefaultImage(e, DniBack)}
                  className={classes.dniImage}
                  onClick={() => openModal(3)}
                />
                <Modal
