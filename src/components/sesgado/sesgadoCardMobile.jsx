...
const TrusterText = `Truster te da ayuda a conocer mejor el historial de ${localStorage.getItem(
  'nombre'
)} y a definir si es la persona que buscas para tus negocios.`
...
const SesgadoCard = () => {
  ...
  return (
    ...
    >
      <hr
        style={{ width: '99vw', position: 'absolute', left: 0 }}
        color="#ACFD00"
      />
      <Grid
        style={{
      ...
      >
        <img
          ...
          alt="greyelipse"
          width="220px"
          style={{ zIndex: 2, marginTop: '-230px' }}
        />
      </Grid>
      <Grid
        xs={12}
      ...
      >
        <img
          ...
          width="160px"
          height="160px"
          style={{ zIndex: 3, marginTop: '-230px', borderRadius: '100px' }}
        />
      </Grid>
      <Grid
        xs={12}
