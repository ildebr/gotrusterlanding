    ...
    <Grid position="static" color="transparent" style={{
      ...
      <Grid container alignItems='center'>
        <Grid container xs={9} xl={9} sm={9} >
          <Grid container justify='flex-start' alignItems='center' xs={12} xl={12} sm={12} style={{  backgroundColor: 'rgba(75, 75, 75, 0.7)', height: '40px', maxWidth: '150px', borderRadius: '10px'}}>
          </Grid>
