      ...
      <Grid container direction={'column'}>
        <Grid container direction={'row'} style={{ padding: '16px' }}>
          <Grid item xs={11}>
            ...
            >
              ...
              />
              <Typography className={classes.titulo}>{name}</Typography>
            </div>
            <Typography className={classes.subtitulo}>{summary}</Typography>
            <Typography className={classes.subtituloAlt}>
              Tienda en Truster {moment(createDate).format('YYYY')}{' '}
            </Typography>
          </Grid>
          <Grid item xs={1}>
            <FontAwesomeIcon
        ...
        <Grid item>
          <div className={classes.divRectangle}>
            ...
            />
            <Typography className={classes.numero}>+0</Typography>
