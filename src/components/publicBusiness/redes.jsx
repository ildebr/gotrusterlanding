...
const useStyles = makeStyles(theme => ({
    rectangulo: {
        background: '#333738', borderRadius: '50%',
        position: 'absolute',
        top: '-0px',
        left: '45px',
        width: 60,
            ...
            {width >= 600 ?
                <div style={{position: 'relative'}}>
                    ...
                    <div className={classes.rectangulo}>
                        <FontAwesomeIcon icon={faEnvelope} style={{
                            color: '#F6F6F6', fontSize: 30
                        }}/>
                    </div>
                    <div className={classes.rectangulo} style={{
                        top: '100px',
                        left: '310px'

                    }}>
                        <FontAwesomeIcon icon={faPhoneAlt} style={{
                            color: '#AAFF00', fontSize: 25
                        }}/>
                    </div>
                    <div className={classes.rectangulo} style={{
                        top: '230px',
                ...
                <div style={{position: 'relative'}}>
                    ...
                    <div className={classes.rectanguloMobile}>
                        <FontAwesomeIcon icon={faEnvelope} style={{
                            color: '#F6F6F6', fontSize: 20
                        }}/>
                    </div>
                    <div className={classes.rectanguloMobile} style={{
                        top: '75px',
                        left: '200px'

                    }}>
                        <FontAwesomeIcon icon={faPhoneAlt} style={{
                            color: '#AAFF00', fontSize: 20
                        }}/>
                    </div>
                    <div className={classes.rectanguloMobile} style={{
                        top: '153px',
