    ...
    return (
        <div>
            ...
            <Grid container className={classes.root} component="main" maxWidth="md">
                ...
                <Grid container item justify="flex-start" xs={12} style={{ padding: 20 }}>
                    <Typography className={classes.title}>Publicá tu negocio gratis en Truster</Typography>
                </Grid>
                <Grid container item justify="flex-start" xs={12} style={{ padding: 20, paddingTop: 30 }}>
                    <Grid container item justify="flex-start" xs={6} >
                        <Typography className={classes.subTitle}>Elevá tu reputación</Typography>
                    </Grid>
                    <Grid container item justify="flex-end" alignItems='flex-end' xs={6} style={{ paddingTop: 20 }}>
