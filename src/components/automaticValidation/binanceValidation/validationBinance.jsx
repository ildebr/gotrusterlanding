...
import eyePhone from '../../../asset/images/automaticvalidation/binance/validationBinance.png'
    ...
    >
      ...
      {width >= 600 ? (
        ...
        <div style={{ justifyContent: 'center', marginTop: '32px' }}>
          <button className={classes.buttonMobile}>Validar</button>
          <button
...
export default ValidationBinance
