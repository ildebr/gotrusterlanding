...
import image from '../../../asset/images/automaticvalidation/facebook/failedFacebook.png';
    ...
    return (
        <Grid position="static" color="transparent" style={{
            ...
            <Grid xs={12} xl={12} sm={12} container justify="center">
                {width >= 600 ?
                    <img src={image} alt='Facebook' width='150px' style={{ marginLeft: '32px' }} />
                    :
                    <img src={image} alt='Facebook' width='120px' style={{ marginLeft: '32px' }} />
                }
            </Grid>
