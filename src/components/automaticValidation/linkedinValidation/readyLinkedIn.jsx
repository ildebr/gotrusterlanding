  ...
  return (
    <Grid position="static" color="transparent" style={{
      ...
      <Grid xs={12} xl={12} sm={12} container justify="center" alignContent="center">
        {width >= 600 ?
          <img src={ready} alt='okLinkedIn' width='150px' style={{ marginLeft: '32px' }} />
          :
          <img src={ready} alt='okLinkedIn' width='120px' style={{ marginLeft: '32px' }} />
        }
      </Grid>
