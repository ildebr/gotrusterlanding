...
import success from '../../../asset/images/automaticvalidation/mercadolibre/mercadolibreexito.png';
            ...
            {width >= 600 ?
                <Grid xs={12} xl={12} sm={12} container justify="center" alignContent="center">
                    <Grid xs={6} xl={6} sm={6} container justify="flex-end" alignContent="center" style={{ marginRight: '10px' }}>
                        <img src={success} alt='okMercadoLibre' width='150px' />
                    </Grid>
                ...
                <Grid xs={12} xl={12} sm={12} container justify="center" alignContent="center">
                    <Grid xs={12} xl={12} sm={12} container justify="center" alignContent="center" >
                        <img src={success} alt='okMercadoLibre' width='120px' style={{marginLeft: '32px'}}/>
                    </Grid>
...
export default SuccessMercadoLibre;
