      ...
      <Grid xs={12} xl={12} sm={12} container style={{ marginTop: '30px' }} justify="center">
        {width >= 600 ? 
          <Typography className={classes.article}>
            Si no sabes que puede haber salido mal, lee <Link underline="always" className={classes.articleMobile}>este artículo</Link>
          </Typography>
          :
        ...
        {width >= 600 ?
        <Grid xs={12} xl={12} sm={12} container style={{ marginTop: '20px', marginBottom: '40px' }} justify="center">
