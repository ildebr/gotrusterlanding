...
export default function MyProfileMobile(props) {
  ...
  useEffect(() => {
    ...
    loadValidation()
    let fecha = new Date(localStorage.getItem('createDate'))
      ...
      validations = (
        ...
        >
          ...
          <img
            ...
            alt="ok"
            width="20px"
            style={{ marginLeft: 3, marginTop: 30, position: 'absolute' }}
          />
          <Link href={goTOAfip}>
            <img
              src={Add}
      ...
      validations = (
        ...
        >
          <Grid container xs={10} xl={10} sm={10} justify="flex-start">
            ...
            >
              No se pudo verificar esta información.{' '}
              <Link
                underline="always"
                style={{
                  color: '#E94342',
  ...
  let occupation =
    localStorage.getItem('occupation') === 'null'
      ? 'Agregue su ocupación'
      : localStorage.getItem('occupation')
  let gender = localStorage.getItem('gender')

  let cellphone =
    localStorage.getItem('cellphone') === 'string'
      ? '(xxx)-(xxxx-xxxx)'
      : localStorage.getItem('cellphone')
  let cuit1 =
    localStorage.getItem('cuit') === 'string'
      ? 'xx-xxxxxxxx-x  '
      : localStorage.getItem('cuit')

  let email = localStorage.getItem('email')
  let dnipro =
    localStorage.getItem('dni') === 'string'
      ? ' xxxxxxxx '
      : localStorage.getItem('dni')

  let adresses =
    localStorage.getItem('Adresses') === ''
      ? 'Dirección'
      : localStorage.getItem('Adresses')
  let nacionality =
    localStorage.getItem('Nacinality') === ''
      ? 'Nacionalidad'
      : localStorage.getItem('Nacinality')
  let newGender = ''
  ...
  let toValidate = (
    ...
    >
      ...
      <img
        ...
        alt="ok"
        width="20px"
        style={{ marginTop: 30, position: 'absolute', marginLeft: 35 }}
      />
    </Grid>
  )
  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          ¿Necesitás editar un dato? Contactate con{' '}
          <Link
            underline="never"
            style={{
              color: '#ACFD00',
