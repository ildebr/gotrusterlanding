...
export default function MyProfileMobile(props) {
  ...
  const ActivatedText = 'Desactivar esta vinculación removerá 2 puntos temporalmente'
  const DeactivatedText = 'Reactivá esta integración para recuperar 2 putnos de recuperación'
  return (
    <Grid position="static" color="transparent" style={{
      ...
      <Grid container justify="flex-start" alignItems='center' xs={12} xl={12} sm={12} style={{ marginTop: '50px', padding: '10px' }}>
      ...
      <Grid container justify="flex-start" alignItems='center' xs={12} xl={12} sm={12} style={{ padding: '10px', marginTop: '40px' }}>
        <Typography className={classes.mydata}>
            Vinculaciones
        </Typography>
      </Grid>
      <Grid container justify="flex-start" alignItems='center' xs={12} xl={12} sm={12} style={{ padding: '10px', marginTop: '20px' }}>
        <Grid container justify="flex-start" alignItems='center' xs={10} xl={10} sm={10}>
          <Typography className={classes.fields}>
      ...
      <Grid container justify="flex-start" alignItems='center' xs={12} xl={12} sm={12} style={{ padding: '10px', marginTop: '20px' }}>
        ...
        <Grid container justify="flex-end" xs={2} xl={2} sm={2}>
          <img src={Meli ? Checked : UnChecked} alt='checked' onClick={() => Switch(1)} />
        </Grid>
        <Grid container justify="flex-end" xs={10} xl={10} sm={10}>
          <Typography className={classes.mydata}>
      ...
      <Grid container justify="flex-start" alignItems='center' xs={12} xl={12} sm={12} style={{ padding: '10px', marginTop: '20px' }}>
        ...
        <Grid container justify="flex-end" xs={2} xl={2} sm={2}>
          <img src={Linked ? Checked : UnChecked} alt='checked' onClick={() => Switch(2)} />
        </Grid>
        <Grid container justify="flex-end" xs={10} xl={10} sm={10}>
          <Typography className={classes.mydata}>
