...
import image from '../../../asset/images/manualValidations/dniError.png'
    ...
    <React.Fragment>
      <div className={classes.rootDiv}>
        ...
        <Typography className={classes.titulo}>
          ¡Bienvenido de nuevo! No pudimos validar tu documento
        </Typography>
