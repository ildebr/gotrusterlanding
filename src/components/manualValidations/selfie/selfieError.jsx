...
import image from '../../../asset/images/manualValidations/selfie/selfieError.png';
        ...
        <React.Fragment>
            <div className={classes.rootDiv}>
                ...
                <Typography className={classes.titulo}>
                    Bienvenido, lamentablemente no pudimos validar tu Selfie
                </Typography>
                ...
                <div style={{display: 'flex', flexDirection: 'row'}}>
                    ...
                    <Typography className={classes.subtitulo2}
                                style={{textDecoration: 'underline', paddingLeft: '8px', cursor: 'pointer'}}>
                        este artículo
                    </Typography>
