      ...
      <div className={classes.rootDiv}>
          ...
          <div className={classes.notMobile}>
            ...
            <div style={{ maxWidth: '300px', marginLeft: '34px' }}>
              <Typography className={classes.texto}>
                1. En la foto debes sostener tu DNI
              </Typography>
              <Typography className={classes.texto}>
                2. En la foto deberás aparecer de frente
              </Typography>

              <Typography className={classes.texto}>
                3. La foto debe mostrár de tu cintura hacia arriba
              </Typography>

              <Typography className={classes.texto}>
                {' '}
                4. En la foto debes sostener un papel con la fecha de hoy
                escrita{' '}
              </Typography>
              <Typography className={classes.texto}>
                Tu letra debe ser legible.
              </Typography>
            </div>
          </div>
        ) : (
        ...
        <div className={classes.onlyMobile}>
          ...
          >
            ...
            <Typography className={classes.texto}>
              {' '}
              4. En la foto debes sostener un papel con la fecha de hoy escrita{' '}
            </Typography>
            <Typography className={classes.texto}>
              Tu letra debe ser legible.
            </Typography>
        ...
        >
          <input
            ...
            type="file"
            hidden
            onChange={(e) => onFileChange(e, 'Factura')}
          />
          <Grid
            container
            direction={'row'}
          ...
          >
            ...
            <Grid item={2}>
              <FontAwesomeIcon
                icon={faPaperclip}
                className={
                  nameImage ? classes.imageColorGray : classes.imageColor
                }
              />
            </Grid>
          </Grid>
