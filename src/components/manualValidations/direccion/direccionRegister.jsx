    ...
    <React.Fragment>
      <div className={classes.rootDiv}>
        ...
        <Typography className={classes.titulo}>
          Para validar tu dirección, te pedimos que adjuntes una factura que la
          valide.
        </Typography>

        <Typography className={classes.subtitulo}>
          Podes utilizar una factura de servicio, contrato de alquiler, resumen
          de banco, etc, etc, etc.
          {show}
        </Typography>
