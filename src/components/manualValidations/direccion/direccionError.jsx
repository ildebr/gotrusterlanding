...
import image from '../../../asset/images/manualValidations/direccion/direccionError.png'
    ...
    <React.Fragment>
      <div className={classes.rootDiv}>
        ...
        <Typography className={classes.titulo}>
          Bienvenido, lamentablemente no pudimos validar tu dirección
        </Typography>
