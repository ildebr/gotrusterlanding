    ...
    return (
        <React.Fragment>
            <Grid container direction={'column'}>
                <Grid container direction={"row"} className={classes.rectangle} >
                        <Grid item>
                            <FontAwesomeIcon icon={faComment} style={{
                                color: '#777777', fontSize: 15, align: "center", padding:'0 16px'
                            }}/>
                        </Grid>
                    <Grid item>
                ...
                <Grid item  className={classes.rectangle} style={{height:'80px', marginTop:'16px', padding:'0 16px'}}>
                ...
                <Grid item  className={classes.rectangle} style={{height:'80px', marginTop:'16px', padding:'0 16px'}}>
                    <Typography className={classes.textoAlt}>
                        Integra tu cuenta de mercadolibre para que tus clientes te conozcan mas.
                    </Typography>
                </Grid>
