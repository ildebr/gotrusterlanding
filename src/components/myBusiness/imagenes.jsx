...
function Imagenes(props) {
  ...
  return (
    <React.Fragment>
      {width >= 600 ? (
        <Typography className={classes.titulo}>Imágenes</Typography>
      ) : (
        <Typography className={classes.titulo}>Galeria</Typography>
      )}
      <Grid
        container
        style={{
          ...
          <React.Fragment>
            <Grid item container style={{ marginTop: '10px' }}>
              <div>
                ...
                <img
                  src={`${UriServices()}/${user}/images/negocio/${
                    imagesArray[displayImage]
                  }`}
                  style={{
                    width: '100%',
                    borderRadius: '10px',
        ...
        <Grid item className={classes.gridFotos} justify="flex-start">
          {imagesArray !== null &&
            ...
            imagesArray.map((imagen) => (
              <div onClick={() => setDisplayImage(imagesArray.indexOf(imagen))}>
                <img
                  src={`${UriServices()}/${user}/images/negocio/${imagen}`}
                  style={{
                    height: '68px',
                    width: '90px',
                    marginRight: '16px',
