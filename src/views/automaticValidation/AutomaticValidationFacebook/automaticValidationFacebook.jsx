...
import ValidationFacebook from '../../../components/automaticValidation/facebookValidation/validationFacebook'
...
class AutomaticValidationFacebook extends Component {
  constructor(props) {
    super(props);
    this.state = {
...
export default withStyles(styles, { withTheme: true })(AutomaticValidationFacebook);