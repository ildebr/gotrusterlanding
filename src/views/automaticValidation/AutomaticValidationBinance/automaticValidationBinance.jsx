...
import ValidationBinance from '../../../components/automaticValidation/binanceValidation/validationBinance'
...
class AutomaticValidationBinance extends Component {
   constructor(props) {
      super(props);
      this.state = {
...
export default withStyles(styles, { withTheme: true })(AutomaticValidationBinance);