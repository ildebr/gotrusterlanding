...
import ValidationPhone from '../../../components/automaticValidation/telephoneValidation/completedPhone'
...
class AutomaticValidation extends Component {
  constructor(props) {
    super(props)
    this.state = {
...
export default withStyles(styles, { withTheme: true })(AutomaticValidation)
