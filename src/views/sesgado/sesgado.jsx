...
import BlackBoxes from '../../components/sesgado/blackBoxes'
import BlackBoxesMobile from '../../components/sesgado/blackBoxesMobile'
import SesgadoCard from '../../components/sesgado/sesgadoCard'
import SesgadoCardMobile from '../../components/sesgado/sesgadoCardMobile'
...
class Sesgado extends Component {
  constructor(props) {
    super(props);
        ...
        <Grid className={classes.test} container maxWidth="md" component="main" >
          <Container component="main" maxWidth="md" container  >
            ...
            <Grid>
              ...
              <ProfileSesgado /> 
              : 
              <ProfileSesgadoMobile/>
              }
            </Grid>
            {
            width >= 600 ? 
            <Grid xs={12} xl={12} sm={12} container style={{ marginTop: '200px' }}>
              <BlackBoxes/>
            </Grid> 
            : 
...
export default withStyles(styles, { withTheme: true })(Sesgado);