  ...
  return (
    <div className={classes.root}>
      <div className={classes.wrapper}>
        ...
        {newsType === 'newAccount' && <NewAccount />}
        {newsType === 'newPassword' && <NewPassword />}
        {newsType === 'validationSuccess' && <ValidationSuccess />}
        {newsType === 'validationFailed' && <ValidationFailed />}
        {newsType === 'levelUp' && <LevelUp />}
