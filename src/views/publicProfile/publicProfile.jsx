        ...
        >
          {width >= 600 ? (
            <div className={classes.background}>
              <img
                src={
                  'https://truster-bucket.s3.us-west-2.amazonaws.com/images/coverPerfil/' +
                  this.state.email +
                  '.png'
                }
                alt="background"
          ...
          >
            <Container component="main" maxWidth="md" container>
              ...
              <Grid>{width >= 600 ? '' : <TrustUsers />}</Grid>
              <Grid>{width >= 600 ? '' : <TrustButton />}</Grid>
              {/*  <Grid>
              ...
              >
                {width >= 600 ? (
                  ...
                  <button className={classes.moreButtonMobile}>
              ...
              <Grid
                ...
                style={{ paddingTop: '30px' }}
              >
                <Typography className={classes.validInfo}></Typography>
              </Grid>
            </Container>
          </Grid>
        </Grid>
