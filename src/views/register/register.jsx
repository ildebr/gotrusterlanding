...
import { UserResource } from '../../services/hostConfig'
...
class Register extends Component {
  ...
  securityPassword = (e) => {
    ...
    if (securityNumber > 0 && securityUp > 0 && securityLower > 0) {
      security = true
    } else {
      security = false
    }
  ...
  render() {
    ...
    let $lastError = this.state.lastNameError
      ? '*no olvides poner tu Apellido'
      : ''
    ...
    let $incompletePassError = this.state.incompletePassError
      ? '*La contraseña debe contener 8 caracteres mínimo,'
      : ''
    let $incompletePassErrorEx = this.state.incompletePassError
      ? '*una minúscula, una mayúscula y un número'
      : ''
    let $emailAvailable = this.state.emailAvailable
      ? '*Correo no disponible'
      : ''
    let $emailAvailableEx = this.state.emailAvailableEx
                    ...
                    {width > 550 ? (
                      <Grid justify="center">
                        ...
                        >
                          ...
                          <EmailCheck
                            changeEmail={(emailState, email) =>
                              this.handlerEmailName(emailState, email)
                            }
                            width={width}
                          />
                          <Typography className={classes.inputTitle2}>
                          ...
                          <InputBase
                            ...
                            className={
                              ...
                              this.state.incompletePassError
                                ? classes.errorFormButton
                                : classes.formButton
                            }
                          ...
                          <Grid container item>
                            ...
                            >
                              <Checkbox
                                ...
                                name="terms"
                                className={
                                  this.state.checkTerError
                                    ? classes.checkTerminosError
                                    : classes.checkTerminos
                                }
                                style={{
                                  color: '#ACFD00',
                                  marginTop: 3,
                              ...
                              <Typography className={classes.normaltext}>
                                Acepto los{' '}
                                <Link
                                  href="https://gotruster.com/terminos-y-condiciones-generales-de-uso-del-sitio"
                                  style={{ color: '#ACFD00' }}
                                >
                                  Condiciones de Uso
                                </Link>
