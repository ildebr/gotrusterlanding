        ...
        >
          {width >= 600 ? (
            <div className={classes.background}>
              <img
                src={`https://truster-bucket.s3.us-west-2.amazonaws.com/images/coverPerfil/${this.state.user}.png`}
                alt="background"
                width={'1935px'}
                height={'470px'}
          ...
          >
            <Container component="main" maxWidth="md" container>
              ...
              <Grid container justify="center">
                {width >= 600 ? (
                  <MyProfileInfo modifiedCover={this.componentDidMount()} />
                ) : (
                  ''
                )}
              </Grid>
