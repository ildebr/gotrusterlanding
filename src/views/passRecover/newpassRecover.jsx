...
class NewpassRecover extends Component {
  ...
  _handleSubmit = (e) => {
    ...
    if (pass === '' || pass2 === '' || pass !== pass2) {
      ...
      auth
        .login('admin', 'Truster2021')
        .then(() => {
          const token = getToken()
          console.log(token)
          cliente
            .post(AccountResetPassEx(), newPass, {
              headers: {
                      ...
                      {this.state.sent === false ? (
                        ...
                        >
                          ...
                          <Grid container justify="center">
                            <Typography
                              className={classes.paperWelcome}
                              style={{ maxWidth: 450 }}
                            >
                          ...
                          <Grid container justify="center">
                            <Typography
                              className={classes.paperWelcome1}
                              style={{ maxWidth: 450 }}
                            >
                              Te enviaremos un correo con un link de
                              recuperación
                            </Typography>
                          </Grid>
                          <Grid container justify="center">
                      ...
                      {this.state.sent === false ? (
                        ...
                        <Grid container justify="center">
                          ...
                          >
                            ...
                            >
                              ¡Listo! Tu contraseña ha sido modificada. Ya podés
                              iniciar sesión.
                            </Typography>
                          </Grid>
                          <Grid
